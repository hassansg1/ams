...
class BuildingController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view($this->route . "/index")
            ->with(['items' => $data['items'], 'data' => $data, 'route' => $this->route,'model_name'=>'Building', 'heading' => $this->heading]);
    }
    ...
    {
        $assignedAssets = Location::where('parent_id', $item)->get();
        ...
        flashSuccess(getLang($this->heading . " has childs cannot be deleted."));
        return redirect(route($this->route . ".index"));
    }
}
