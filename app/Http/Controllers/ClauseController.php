...
class ClauseController extends BaseController
{
    ...
    public function filter(Request $request)
    {
        ...
        return response()->json([
            ...
            'html' => view($this->route . "/form_rows")
                ->with(['items' => $data['items'], 'data' => $data, 'route' => $this->route,'model_name'=>'StandardClause', 'heading' => $this->heading])->render(),
            'data' => $data
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view($this->route . "/create")
            ->with(['route' => $this->route, 'heading' => $this->heading, 'cancelRoute' => $cancelRoute, "parent" => $parent ?? null]);
    }
