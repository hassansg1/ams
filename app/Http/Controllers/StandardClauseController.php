...
class StandardClauseController extends BaseController
{
    ...
    public function index(Request $request, $standardId)
    {
        ...
        return view($this->route . "/index")
            ->with(['items' => $tree, 'data' => $data, 'standardId' => $standardId, 'request' => $request, 'route' => $this->route, 'model_name'=>'StandardClause','heading' => $this->heading, 'standard' => $standard, 'customHeading' => true]);
    }
    ...
    {
        if ($request->id)
            $parent = StandardClause::find($request->id);
        return view($this->route . "/create")
            ->with(['route' => $this->route, 'heading' => $this->heading, "parent" => $parent ?? null]);
    }
