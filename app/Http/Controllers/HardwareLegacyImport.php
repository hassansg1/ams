...
class HardwareLegacyImport extends Controller
{
    /**
    ...
    {
        return view('import.index')->with(['action' => 'hardware_legacy_import.store']);
    }
    ...
    public function store(Request $request)
    {
        ...
        $modelClass = HardwareLegacy::class;
        $tableNameRaw = 'hardware_legacies';
        $logs = [];
        $success = true;
