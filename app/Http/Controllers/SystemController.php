...
class SystemController extends BaseController
{
 ...
 public function __construct()
 {
    ...
    public function index(Request $request)
    {
        ...
        ->with(['items' => $data['items'], 'route' => $this->route,'model_name'=>'System', 'data' => $data,'heading' => $this->heading]);
    }
    /**
     * @return Application|Factory|View
     */
    ...
    public function show($item)
    {
        ...
        $method = 'show';
        return view($this->route . '.view')->with(['route' => $this->route, 'item' => $item, 'heading' => $heading, 'selectedAssets'=>$child_arr,'method' => $method,'clone' => $request->clone ?? null]);
    }
