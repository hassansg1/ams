...
class AttachmentController extends BaseController
{
    ...
    public function __construct()
    {
        ...
        \Illuminate\Support\Facades\View::share('top_heading', 'Document Library');
    }
    /**
    ...
    public function show($item)
    {
        ...
        $method = 'view';
        return view($this->route . '.view')->with(['route' => $this->route, 'item' => $item, 'heading' => $this->heading, 'clone' => $request->clone ?? null, 'method'=> $method]);
    }
