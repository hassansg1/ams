...
class StandardClauseTreeEditController extends BaseController
{
    protected $model;
    protected $route;
    protected $heading;
    ...
    public function __construct()
    {
        ...
        $this->route = 'clause_edit_tree';
        $this->heading = 'Clause';
        \Illuminate\Support\Facades\View::share('top_heading', 'Clauses Tree');
    }
    ...
    public function index(Request $request, $standardId)
    {
        ...
        return view($this->route . "/index")
            ->with(['standardId' => $standardId, 'request' => $request, 'route' => $this->route, 'heading' => $this->heading, 'standard' => $standard, 'customHeading' => true]);
    }
    ...
    public function openEditClausePopup()
    {
