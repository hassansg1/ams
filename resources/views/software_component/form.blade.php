    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <label for="{{ isset($item) ? $item->id:'' }}software_id" class="form-label required">Software Name</label>
                        <select class="form-select form-select-input" name="software_id"
                                id="{{ isset($item) ? $item->id:'' }}software_id" required>
                    ...
                    <div class=" col-lg-4">
                        <div class="mb-3">
                            <label for="{{ isset($item) ? $item->id:'' }}description"
                                   class="form-label">Software Component Description</label>
