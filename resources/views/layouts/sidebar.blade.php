    ...
    <div data-simplebar class="h-100">
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                <li>
                    <a onclick="location.href='{{ url('') }}'" class="waves-effect">
...
{{--                        <li><a href="{{route('scada.dashboard')}}" key="t-product-detail">Skada</a></li>--}}
{{--                        <li><a href="{{route('smart.dashboard')}}" key="t-products">smart</a></li>--}}
{{--                        <li><a href="{{ route('information.dashboard') }}" class="waves-effect">Information Security</a></li>--}}
{{--                    </ul>--}}
                </li>
                <li style="margin-top: 35px;">
                    ...
                    <img src="{{ URL::asset ('/assets/images/asset.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
                        ...
                        <span key="t-ecommerce">Asset Management</span>
                    </a>
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
...
{{--                        <li><a href="{{route('process.index')}}" key="t-products">Processes & Criticality</a></li>--}}
                        ...
                        <li><a href="{{ route('hardware_legacy.index') }}" class="waves-effect">Hardware Model</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <img src="{{ URL::asset ('/assets/images/software.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <img src="{{ URL::asset ('/assets/images/patch.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
                ...
                <li>
                    ...
                    <img src="{{ URL::asset ('/assets/images/firewall.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <img src="{{ URL::asset ('/assets/images/risk.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
                    ...
                    <ul class="sub-menu mm-collapse" aria-expanded="false">
                        ...
                        <li><a href="{{route('risk_settings.index')}}" key="t-orders">Global Settings</a>
                        <li><a href="{{route('risk_report.index')}}" key="t-orders">Risk Report</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <img src="{{ URL::asset ('/assets/images/reports.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
...
{{--                        <li>--}}
{{--                            <a href="{{ url('reports/testing/asset_report') }}" class="waves-effect">--}}
{{--                                <span key="t-dashboards">Testing Asset Report</span>--}}
{{--                            </a>--}}
{{--                        </li>--}}
                        <li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    <img src="{{ URL::asset ('/assets/images/nazomi.svg') }}" alt="" height="28" width="20" style="margin-right: 5px;">
