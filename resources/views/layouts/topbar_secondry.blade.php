        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="height: 10px">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ isset($logo->logo) ? URL::asset('images/logo/'.$logo->logo) :  URL::asset ('/assets/images/logo.svg')}}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="{{ url('') }}" class="logo logo-light">
                    <h3 style="margin-top: 18px;color: white;font-size: 23px;"><img src="{{ isset($logo->logo) ? URL::asset('images/logo/'.$logo->logo) :  URL::asset ('/assets/images/logo.svg')}}" alt="" height="43"></h3>
                </a>
            </div>
