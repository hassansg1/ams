...
<header id="page-topbar">
    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="height: 10px">
                <a href="index" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ isset($logo->logo) ? URL::asset('images/logo/'.$logo->logo) :  URL::asset ('/assets/images/logo.svg')}}"
                             alt="" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="{{ url('') }}" class="logo logo-light">
                    <h3 style="margin-top: 18px;color: white;font-size: 23px;"><img
                                src="{{ isset($logo->logo) ? URL::asset('images/logo/'.$logo->logo) :  URL::asset ('/assets/images/logo.svg')}}"
                                alt="" height="43"></h3>
                </a>
            </div>
            ...
            @if(Auth::user()->hasPermissionTo('Import Export'))
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" style="">
                        <a href="{{ route('import.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Import Organizational Data</span>
                        </a>
                        <a href="{{ url('hardware_legacy_import') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Import Hardware Model Data</span>
                        </a>
                        <a href="{{ route('import.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Import Assets Data</span>
                        </a>
                        <a href="{{ route('clause_import.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Import Clauses Data</span>
                        </a>
                        ...
                        <a href="{{ route('user_import.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Import Users Data</span>
                        </a>
                        <a href="{{ route('user_id_import.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Import User ID's Data</span>
                        </a>
            ...
            @if(Auth::user()->hasPermissionTo('Standard Compliance'))
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" style="">
                        <a href="{{ route('standard.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                        ...
                        <a href="{{ route('version.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                ...
                <div class="dropdown-menu dropdown-menu-end" style="">
                    @if(Auth::user()->hasPermissionTo('Logs'))
                        <a href="{{ route('log.index') }}" class="dropdown-item notify-item language" data-lang="eng">
                            <span class="align-middle">Change Logs</span>
                        </a>

                        <a href="{{ route('columns_lable.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
                            <span class="align-middle">Columns Lable</span>
                        </a>
                    @endif
                    ...
                    @if(Auth::user()->hasPermissionTo('Approvel Requests'))
                        <a href="{{ route('approval.index') }}" class="dropdown-item notify-item language"
                           data-lang="eng">
            ...
            <div style="margin-left: 50px" class="dropdown d-inline-block">
                <form class="risk_global_form" method="post" enctype="multipart/form-data"
                      action="{{ route('risk_settings.store') }}">
                    {{ csrf_field() }}
                    <div style="margin-top: 15%;font-size: 15px">
                        <label class="d-inline-block" for="from_year"><small><strong>Threat
                                    Level:</strong></small></label>
                        <select onchange="$('.risk_global_form').submit()" name="threat_level"
                                class="form-control form-control-sm d-inline-block"
                                style="width: auto;"
                                id="global_threat_level">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-lg-inline-block ms-1">
                ...
                {{--                    <img src="{{ URL::asset ('/assets/images/Notification.svg') }}" alt="" height="18">--}}

                {{--                </button>--}}
            </div>
            <div class="dropdown d-none d-lg-inline-block ms-1">
                {{--                <button type="button" class="btn header-item noti-icon waves-effect" data-toggle="fullscreen">--}}
                {{--                    <img src="{{ URL::asset ('/assets/images/message.svg') }}" alt="" height="18">--}}
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <div class="d-none d-xl-inline-block ms-1" key="t-henry">
