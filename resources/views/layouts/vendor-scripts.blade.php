...
<script>
        ...
        $('#helpSaveButton').on('click', function () {
            $.ajax({
                ...
                success: function (result) {
                    if (result.status) {
                        doSuccessToast();
                        $('#text_hel_div').css('display', 'none');
                        $('#text_manager').css('display', 'block');
                        $('#helpSaveButton').hide();

                        function refresh() {
                            $('#text_manager').html(CKEDITOR.instances.help_text.getData());
                            $('#help_text').val(CKEDITOR.instances.help_text.getData());
                        }
            ...
            success: function (result) {
                if (result.status) {
                    $searchableTree = $('#default-tree').treeview({
                        ...
                        // colors
                        color: '#808080', // '#000000',
                        backColor: '#808080', // '#FFFFFF',
                        borderColor: undefined, // '#dddddd',
                        onhoverColor: '#808080',
                        searchResultColor: '#808080',
    ...
    function collapseClause(id) {
        $('.' + id).css('display', 'none');
        $('#collapse_' + id).css('display', 'none');
        $('#expand_' + id).css('display', 'inline-block');
    }

    function showClause(id) {
        $('.' + id).css('display', 'table-row');
        $('#collapse_' + id).css('display', 'inline-block');
        $('#expand_' + id).css('display', 'none');
    }

    function changeLocation(ref) {
        let id = $(ref).val();
        location.href = '/view/assets/' + id + '/0';
    }
