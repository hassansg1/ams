                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ isset($item) ? $item->risk_assesment_id:old('risk_assesment_id') ?? ''  }}"
                                       class="form-control" id="{{ isset($item) ? $item->id:'' }}risk_assesment_id" name="risk_assesment_id" required>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ isset($item) ? $item->title:old('title') ?? ''  }}"
                                       class="form-control" id="{{ isset($item) ? $item->id:'' }}title" name="title" required>
                            </div>
                        </div>
