                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="compliant" id="compliant" required>
                                            ...
                                            @php($complianceVal = $compliance->compliant ?? 4 )
                                            @foreach(getGapsForStandard($clause->standard->id) as $id=>$label)
                                                <option
                                                        {{ $complianceVal == $id ? 'selected' : '' }}
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea
                                                ...
                                                rows="6">{!! $compliance->comment ?? '' !!}</textarea>
                                    </div>
                                </div>
