                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="{{ isset($item) ? $item->id:'' }}password"
                                   class="form-label">Password <i class="fa fa-bars" rel="tooltip" title="Password must be at least 7 characters.Password must contain one lowercase, uppercase, digit and a special character" id="blah"></i></label>
                            <input type="password" value=""
                                   class="form-control"
                                   id="{{ isset($item) ? $item->id:'' }}password"
                                   name="password">
                            <p>Password must be at least 7 characters.Password must contain one lowercase, uppercase, digit and a special character</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
