...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::resources([
        ...
        'columns_lable' => \App\Http\Controllers\ColumnLablesController::class,
//        'activity_log' => \App\Http\Controllers\ActivityLogController::class,
        ...
        'hardware_legacy_import' => \App\Http\Controllers\HardwareLegacyImport::class,
        'software_legacy_import' => \App\Http\Controllers\SoftwareLegacyImport::class,
        ...
        'clause_edit_tree' => \App\Http\Controllers\StandardClauseTreeEditController::class,
        ...
        'risk_settings' => \App\Http\Controllers\RiskSettingsController::class,
        'risk_report' => \App\Http\Controllers\RiskReportController::class,
    ...
    Route::get('hardware/model/{type}', [\App\Http\Controllers\HardwareLegacyController::class, 'index']);
    ...
    Route::get('standards/tree/{standard}/clause', [\App\Http\Controllers\StandardClauseTreeEditController::class, 'index']);
    Route::get('openEditClausePopup', [\App\Http\Controllers\StandardClauseTreeEditController::class, 'openEditClausePopup']);
    //................. ComplainceData...........
    ...
    Route::post('updateColor', [App\Http\Controllers\RiskReportController::class, 'updateColor']);
    Route::post('loadRiskTable', [App\Http\Controllers\RiskReportController::class, 'loadRiskTable']);
    Route::post('updateRiskCriteria', [App\Http\Controllers\RiskReportController::class, 'updateRiskCriteria']);
    ...
    Route::group(['prefix' => 'chart'], function () {
        ...
        Route::post('addComplianceRow', [\App\Http\Controllers\ComplianceChartController::class, 'addComplianceRow']);
        Route::POST('patch_report', [\App\Http\Controllers\ComplianceChartController::class, 'patchReport'])->name('chart.patch_report');
        Route::post('compliance_chart_spider', [\App\Http\Controllers\ComplianceChartController::class, 'spiderChart'])->name('chart.compliance_spider');
        Route::get('assets_chart', [\App\Http\Controllers\ComplianceChartController::class, 'assets_chart']);
        Route::get('assets_functions_chart', [\App\Http\Controllers\AssetCountFunctionBase::class, 'render']);
        Route::get('assets_criticality_chart', [\App\Http\Controllers\AssetsCriticalityChartController::class, 'render']);
    });
    ...
    Route::post('bulkDelete', [\App\Http\Controllers\AjaxController::class, 'bulkDelete'])->name('bulk.delete');
    ...
    Route::get('asset_function_dashboard_unit/type/{unit_id}', [\App\Http\Controllers\AjaxController::class, 'unit_wise_site']);
    Route::get('asset_function_dashboard_site/type/{site_id}', [\App\Http\Controllers\AjaxController::class, 'site_wise_sub_site']);
    ...
    Route::post('asset_function/name', [\App\Http\Controllers\AjaxController::class, 'asset_function_name']);
    Route::get('asset/functions/name', [\App\Http\Controllers\AjaxController::class, 'asset_functions_name']);
    Route::post('make/model', [\App\Http\Controllers\AjaxController::class, 'make_model']);
    Route::get('hardware/make/name', [\App\Http\Controllers\AjaxController::class, 'hardware_make']);
    ...
    Route::get('dashboard/scada', [\App\Http\Controllers\DashBoardController::class, 'scada'])->name('scada.dashboard');
    Route::get('dashboard/smart', [\App\Http\Controllers\DashBoardController::class, 'smart'])->name('smart.dashboard');
    Route::get('dashboard/information_security', [\App\Http\Controllers\DashBoardController::class, 'information_security'])->name('information.dashboard');
    ...
    Route::post('clause_tree', [\App\Http\Controllers\LocTreeController::class, 'clause_tree'])->name('clause_tree');
    ...
    Route::get('asset_lending_page/{id}/{nodeid?}', [\App\Http\Controllers\AssetLandingPageController::class, 'index'])->name('view/assets');
//    Patch Approval
...
Route::group(['prefix' => 'reports'], function () {
    ...
    Route::get('testing/asset_report', [\App\Http\Controllers\AssetReportController::class, 'testing']);
...
Route::post('loadVersionsForSpider',[\App\Http\Controllers\ComplianceChartController::class,'loadVersionsForSpider']);
